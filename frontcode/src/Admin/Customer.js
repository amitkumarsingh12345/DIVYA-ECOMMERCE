...
const Customer = () => {
    ...
    return (
        <>
            <h4 className='p-3 m-0 fw-bold text-secondary' style={{
                textAlign: 'center',
            ...
            <Accordion>
                {
                    data ? data.map((data, index) => (
                        <Accordion.Item eventKey={index} className='mt-2'>
                            <Accordion.Header>
                                <div className='d-flex justify-content-center flex-wrap align-items-center text-primary fs-5'>
                                    <div className='me-md-5'>
                                        <i className="fa-solid fa-circle-user m-3 fs-1"></i>
                                    </div>
                                    <div className='me-md-5'>
                                        {data.name}
                                    </div>
