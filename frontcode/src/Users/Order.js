...
const Order = () => {
  ...
  const orderHandler = async () => {
    let data = await axios.get(`${window.location.origin}/api/v5/order/search`);
  ...
  return (
    <>
      {
        alldata?.length > 0 ? <>
          <div className='d-flex flex-column justify-content-center overflow-auto w-100 m-auto mt-2'>
